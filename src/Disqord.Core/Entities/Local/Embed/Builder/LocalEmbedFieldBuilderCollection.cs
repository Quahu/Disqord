...
namespace Disqord
{
    ...
    /// </remarks>
    internal sealed class LocalEmbedFieldBuilderCollection : IList<LocalEmbedFieldBuilder>, IReadOnlyList<LocalEmbedFieldBuilder>
    {
        ...
        /// <inheritdoc cref="List{T}.Add(T)"/>
        /// <exception cref="ArgumentNullException"></exception>
        public void AddRange(IEnumerable<LocalEmbedFieldBuilder> fields)
        {
            if (fields == null)
            ...
            if (_list.Count + fieldArray.Length > LocalEmbedBuilder.MAX_FIELDS_AMOUNT)
                throw new InvalidOperationException($"The embed builder must not contain more than {LocalEmbedBuilder.MAX_FIELDS_AMOUNT} fields.");
