...
namespace Disqord
{
    ...
    public sealed class LocalEmbedBuilder : ICloneable
    {
        ...
        private readonly LocalEmbedFieldBuilderCollection _fields;
        ...
        {
            _fields = new LocalEmbedFieldBuilderCollection();
        }
        ...
        internal LocalEmbedBuilder(LocalEmbedBuilder builder)
        {
            ...
            _fields = new LocalEmbedFieldBuilderCollection(builder.Fields.Select(x => x.Clone()));
        }
