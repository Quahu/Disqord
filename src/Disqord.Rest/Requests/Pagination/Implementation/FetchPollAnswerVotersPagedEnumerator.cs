...
public class FetchPollAnswerVotersPagedEnumerator : PagedEnumerator<IUser>
{
    ...
    public FetchPollAnswerVotersPagedEnumerator(
        IRestClient client,
        ...
        IReadOnlyList<IUser>? previousPage, IRestRequestOptions? options = null, CancellationToken cancellationToken = default)
    {
        ...
        return Client.InternalFetchPollAnswerVotersAsync(_channelId, _messageId, _answerId, NextPageSize, startFromId, options, cancellationToken);
    }
}
