...
namespace Disqord.Rest
{
    ...
    public abstract class PagedEnumerator<TEntity> : IPagedEnumerator<TEntity>
    {
        ...
        protected abstract Task<IReadOnlyList<TEntity>> NextPageAsync(IReadOnlyList<TEntity> previousPage, IRestRequestOptions options = null, CancellationToken cancellationToken = default);
