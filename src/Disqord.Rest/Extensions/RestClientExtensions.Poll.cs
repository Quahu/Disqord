...
{
    public static IPagedEnumerable<IUser> EnumerateAnswerVoters(this IRestClient client,
        ...
        IRestRequestOptions? options = null)
    {
        ...
        return PagedEnumerable.Create((state, cancellationToken) =>
        {
            ...
            return new FetchAnswerVotersPagedEnumerator(client, channelId, messageId, answerId, limit, startFromId, options, cancellationToken);
        }, (client, channelId, messageId, answerId, limit, startFromId, options));
    }

    public static Task<IReadOnlyList<IUser>> FetchAnswerVotersAsync(this IRestClient client,
        ...
        IRestRequestOptions? options = null, CancellationToken cancellationToken = default)
    {
        ...
        if (limit <= Discord.Limits.Rest.FetchPollAnswerVotersPageSize)
            return client.InternalFetchAnswerVotersAsync(channelId, messageId, answerId, limit, startFromId, options, cancellationToken);

        var enumerable = client.EnumerateAnswerVoters(channelId, messageId, answerId, limit, startFromId, options);
        return enumerable.FlattenAsync(cancellationToken);
    }

    internal static async Task<IReadOnlyList<IUser>> InternalFetchAnswerVotersAsync(this IRestClient client,
