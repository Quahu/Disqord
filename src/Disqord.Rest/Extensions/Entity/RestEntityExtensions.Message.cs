...
namespace Disqord.Rest
{
    ...
    {
        public static async Task<IMessageChannel> FetchChannelAsync(this IMessage message, IRestRequestOptions options = null, CancellationToken cancellationToken = default)
        {
        ...
        public static Task AddReactionAsync(this IMessage message, LocalEmoji emoji, IRestRequestOptions options = null, CancellationToken cancellationToken = default)
        {
            var client = message.GetRestClient();
            return client.AddReactionAsync(message.ChannelId, message.Id, emoji, options, cancellationToken);
        }

        public static Task RemoveOwnReactionAsync(this IMessage message, LocalEmoji emoji, IRestRequestOptions options = null, CancellationToken cancellationToken = default)
        {
            var client = message.GetRestClient();
            return client.RemoveOwnReactionAsync(message.ChannelId, message.Id, emoji, options, cancellationToken);
        }

        public static Task RemoveReactionAsync(this IMessage message, LocalEmoji emoji, Snowflake userId, IRestRequestOptions options = null, CancellationToken cancellationToken = default)
        {
            var client = message.GetRestClient();
        ...
        public static Task ClearReactionsAsync(this IMessage message, LocalEmoji emoji = null, IRestRequestOptions options = null, CancellationToken cancellationToken = default)
        {
            var client = message.GetRestClient();
            return client.ClearReactionsAsync(message.ChannelId, message.Id, emoji, options, cancellationToken);
        }

        public static Task<IUserMessage> ModifyAsync(this IUserMessage message, Action<ModifyMessageActionProperties> action, IRestRequestOptions options = null, CancellationToken cancellationToken = default)
        {
            var client = message.GetRestClient();
            return client.ModifyMessageAsync(message.ChannelId, message.Id, action, options, cancellationToken);
        }

        public static Task DeleteAsync(this IMessage message, IRestRequestOptions options = null, CancellationToken cancellationToken = default)
        {
            var client = message.GetRestClient();
            return client.DeleteMessageAsync(message.ChannelId, message.Id, options, cancellationToken);
        }

        public static Task PinAsync(this IUserMessage message, IRestRequestOptions options = null, CancellationToken cancellationToken = default)
        {
            var client = message.GetRestClient();
            return client.PinMessageAsync(message.ChannelId, message.Id, options, cancellationToken);
        }

        public static Task UnpinAsync(this IUserMessage message, IRestRequestOptions options = null, CancellationToken cancellationToken = default)
        {
            var client = message.GetRestClient();
