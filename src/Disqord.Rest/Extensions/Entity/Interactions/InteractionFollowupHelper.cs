...
namespace Disqord.Rest
{
    ...
    public class InteractionFollowupHelper
    {
        ...
        /// <returns>
        ///     A <see cref="Task{TResult}"/> representing the request with the result being the fetched message.
        /// </returns>
        ...
        /// <param name="cancellationToken"> The cancellation token to observe. </param>
        /// <returns>
        ///     A <see cref="Task{TResult}"/> representing the request with the result being the modified message.
        /// </returns>
        ...
        /// <param name="cancellationToken"> The cancellation token to observe. </param>
        /// <returns>
        ///     A <see cref="Task{TResult}"/> representing the request with the result being the sent message.
        /// </returns>
