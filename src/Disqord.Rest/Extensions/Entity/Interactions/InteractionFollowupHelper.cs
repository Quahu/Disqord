...
namespace Disqord.Rest
{
    public class InteractionFollowupHelper
    {
        ...
        public Task<IUserMessage> FetchResponseAsync(IRestRequestOptions options = null, CancellationToken cancellationToken = default)
        {
        ...
        public Task<IUserMessage> ModifyResponseAsync(Action<ModifyWebhookMessageActionProperties> action, IRestRequestOptions options = null, CancellationToken cancellationToken = default)
        {
            var client = Interaction.GetRestClient();
        ...
        public Task DeleteResponseAsync(IRestRequestOptions options = null, CancellationToken cancellationToken = default)
        {
            var client = Interaction.GetRestClient();
            return client.DeleteInteractionResponseAsync(Interaction.ApplicationId, Interaction.Token, options, cancellationToken);
        }

        public Task<IUserMessage> SendAsync(LocalInteractionFollowup followup, IRestRequestOptions options = null, CancellationToken cancellationToken = default)
        {
            var client = Interaction.GetRestClient();
        ...
        public Task<IUserMessage> FetchAsync(Snowflake followupId, IRestRequestOptions options = null, CancellationToken cancellationToken = default)
        {
            var client = Interaction.GetRestClient();
        ...
        public Task<IUserMessage> ModifyAsync(Snowflake followupId, Action<ModifyWebhookMessageActionProperties> action, IRestRequestOptions options = null, CancellationToken cancellationToken = default)
        {
            var client = Interaction.GetRestClient();
        ...
        public Task DeleteAsync(Snowflake followupId, IRestRequestOptions options = null, CancellationToken cancellationToken = default)
        {
            var client = Interaction.GetRestClient();
