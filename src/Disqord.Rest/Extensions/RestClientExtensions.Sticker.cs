...
{
    public static async Task<ISticker> FetchStickerAsync(this IRestClient client,
        Snowflake stickerId,
    ...
    public static async Task<IReadOnlyList<IStickerPack>> FetchStickerPacksAsync(this IRestClient client,
        IRestRequestOptions? options = null, CancellationToken cancellationToken = default)
    {
    ...
    public static async Task<IReadOnlyList<IGuildSticker>> FetchGuildStickersAsync(this IRestClient client,
        Snowflake guildId,
        IRestRequestOptions? options = null, CancellationToken cancellationToken = default)
    {
    ...
    public static async Task<IGuildSticker> FetchGuildStickerAsync(this IRestClient client,
    ...
    public static async Task<IGuildSticker> CreateGuildStickerAsync(this IRestClient client,
        Snowflake guildId, string name, string tags, Stream image, StickerFormatType imageType, string? description = null,
        IRestRequestOptions? options = null, CancellationToken cancellationToken = default)
    {
    ...
    public static async Task<IGuildSticker> ModifyGuildStickerAsync(this IRestClient client,
        Snowflake guildId, Snowflake stickerId,
    ...
    public static Task DeleteGuildStickerAsync(this IRestClient client,
        Snowflake guildId, Snowflake stickerId,
        IRestRequestOptions? options = null, CancellationToken cancellationToken = default)
