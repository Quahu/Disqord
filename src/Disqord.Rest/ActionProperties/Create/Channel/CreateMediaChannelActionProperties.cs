...
public class CreateMediaChannelActionProperties : CreateNestedChannelActionProperties
{
    ...
    /// <summary>
    ///     Sets whether the channel requires a tag to be specified for threads created in it.
    /// </summary>
    /// <remarks>
    ...
    internal CreateMediaChannelActionProperties()
    { }
}
