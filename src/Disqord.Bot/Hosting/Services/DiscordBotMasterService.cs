...
namespace Disqord.Bot.Hosting
{
    ...
    ///         </item>
    ///         <item>
    ///             <term> <see cref="DiscordBotService.OnCommandNotFound(DiscordCommandContext)"/> </term>
    ///         </item>
    ///     </list>
    /// </summary>
    ...
    public class DiscordBotMasterService : IBindable<DiscordBotBase>
    {
        ...
        public DiscordBotService[] MessageReceivedServices { get; private set; }
        public DiscordBotService[] NonCommandReceivedServices { get; private set; }
        public DiscordBotService[] CommandNotFoundServices { get; private set; }
        ...
        public void Bind(DiscordBotBase value)
        {
            ...
            foreach (var service in Bot.Services.GetServices<DiscordClientService>())
            {
                ...
                if (DiscordClientMasterService.IsOverridden(botService, nameof(DiscordBotService.OnCommandNotFound), typeof(DiscordCommandContext)))
