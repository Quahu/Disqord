...
namespace Disqord.Rest.Api
{
    public static partial class RestApiClientExtensions
    {
        ...
        public static Task<ApplicationCommandGuildPermissionsJsonModel> SetApplicationCommandPermissionsAsync(this IRestApiClient client, Snowflake applicationId, Snowflake guildId, Snowflake commandId, SetApplicationCommandPermissionsJsonRestRequestContent content, IRestRequestOptions options = null)
        {
