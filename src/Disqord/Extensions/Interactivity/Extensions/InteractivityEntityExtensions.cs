...
namespace Disqord.Extensions.Interactivity
{
    ...
    {
        public static Task<MessageReceivedEventArgs> WaitForMessageAsync(this IMessageChannel channel,
        ...
        public static Task<ReactionAddedEventArgs> WaitForReactionAsync(this IMessage message,
            Predicate<ReactionAddedEventArgs> predicate = null,
            TimeSpan timeout = default, CancellationToken cancellationToken = default)
        {
