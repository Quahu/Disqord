...
namespace Disqord
{
    public abstract partial class CachedMessage : CachedSnowflakeEntity, IMessage
    {
        ...
        public RestRequestEnumerator<RestUser> GetReactionEnumerator(IEmoji emoji, int limit, RetrievalDirection? direction = null, Snowflake? startFromId = null)
            => Client.GetReactionEnumerator(Channel.Id, Id, emoji, limit, direction, startFromId);

        public Task<IReadOnlyList<RestUser>> GetReactionsAsync(IEmoji emoji, int limit = 100, RetrievalDirection? direction = null, Snowflake? startFromId = null, RestRequestOptions options = null)
