...
namespace Disqord.Gateway
{
    ...
    public interface IRichActivity : IActivity
    {
        ...
        ///     Returns <see langword="null"/> if there is no start timestamp or its value is invalid.
        /// </summary>
        DateTimeOffset? StartedAt { get; }

        /// <summary>
        ///     Gets when this activity ends.
        ///     Returns <see langword="null"/> if there is no end timestamp or its value is invalid.
        /// </summary>
        ...
        /// <summary>
        ///     Gets the application ID of this activity.
        ///     Returns <see langword="null"/> if there is none.
        /// </summary>
