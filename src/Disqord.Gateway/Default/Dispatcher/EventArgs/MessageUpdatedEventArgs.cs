...
namespace Disqord.Gateway
{
    public class MessageUpdatedEventArgs : EventArgs
    {
        ...
        /// </summary>
        /// <remarks>
        ///     This is exposed as the model often contains little to no data required to construct a proper message object.
        ///     Inspect this object to detect changes for uncached messages.
        /// </remarks>
        public MessageUpdateJsonModel Model { get; }

        public MessageUpdatedEventArgs(CachedUserMessage oldMessage, CachedUserMessage newMessage, MessageUpdateJsonModel model)
        {
